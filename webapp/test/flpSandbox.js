		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zmassmeasdoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmassmeasdoc-display": {
								"semanticObject": "zmassmeasdoc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmassmeasdoc",
									"url": sap.ui.require.toUrl("zmassmeasdoc")
								}
							}
						}
					}
